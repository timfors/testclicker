...
public class GameEventsListenerEditor : Editor
{
    ...
    private void Draw()
    {
        SerializedProperty scenes = serializedObject.FindProperty("_gameEvents");
        SerializedProperty starts = serializedObject.FindProperty("_responces");
        ...
        GUILayout.Space(50);
        GUILayout.Label("Responce", EditorStyles.wordWrappedLabel);
        //GUILayout.Label("\n");
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            serializedObject.FindProperty("_gameEvents").arraySize++;
            serializedObject.ApplyModifiedProperties();
        }
        if (GUILayout.Button("-", EditorStyles.toolbarButton, GUILayout.Width(40), GUILayout.Height(40)))
        {
